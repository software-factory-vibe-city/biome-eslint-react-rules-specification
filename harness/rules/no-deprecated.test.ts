...
const cases = [
  { code: `var element = React.createElement('p', {}, null);`, filename: "test.jsx" },
  { code: `var clone = React.cloneElement(element);`, filename: "test.jsx" },
  { code: `ReactDOM.cloneElement(child, container);`, filename: "test.jsx" },
  { code: `ReactDOM.findDOMNode(instance);`, filename: "test.jsx" },
  { code: `ReactDOM.createPortal(child, container);`, filename: "test.jsx" },
  { code: `ReactDOMServer.renderToString(element);`, filename: "test.jsx" },
  { code: `ReactDOMServer.renderToStaticMarkup(element);`, filename: "test.jsx" },
  { code: `
  ...
  { code: `
      ...
      `, filename: "test.jsx" },
  { code: `React.renderComponent()`, filename: "test.jsx" },
  { code: `/** @jsx Foo */ Foo.renderComponent()`, filename: "test.jsx" },
  { code: `this.transferPropsTo()`, filename: "test.jsx" },
  { code: `React.addons.TestUtils`, filename: "test.jsx" },
  { code: `React.addons.classSet()`, filename: "test.jsx" },
  { code: `React.render(element, container);`, filename: "test.jsx" },
  { code: `React.unmountComponentAtNode(container);`, filename: "test.jsx" },
  { code: `React.findDOMNode(instance);`, filename: "test.jsx" },
  { code: `React.renderToString(element);`, filename: "test.jsx" },
  { code: `React.renderToStaticMarkup(element);`, filename: "test.jsx" },
  { code: `React.createClass({});`, filename: "test.jsx" },
  { code: `React.PropTypes`, filename: "test.jsx" },
  { code: `var {createClass} = require('react');`, filename: "test.jsx" },
  { code: `var {createClass, PropTypes} = require('react');`, filename: "test.jsx" },
  { code: `import {createClass} from 'react';`, filename: "test.jsx" },
  { code: `import {createClass, PropTypes} from 'react';`, filename: "test.jsx" },
  { code: `
      import React from 'react';
      const {createClass, PropTypes} = React;
    `, filename: "test.jsx" },
  { code: `import {printDOM} from 'react-addons-perf';`, filename: "test.jsx" },
  { code: `
        import ReactPerf from 'react-addons-perf';
        const {printDOM} = ReactPerf;
      `, filename: "test.jsx" },
  { code: `React.DOM.div`, filename: "test.jsx" },
  { code: `
...
describe("no-deprecated", () => {
  ...
  describe("valid", () => {
    it("valid[0]: var element = React.createElement('p', {}, null);", ({ task }) => {
    ...
    it("valid[1]: var clone = React.cloneElement(element);", ({ task }) => {
    ...
    it("valid[2]: ReactDOM.cloneElement(child, container);", ({ task }) => {
    ...
    it("valid[3]: ReactDOM.findDOMNode(instance);", ({ task }) => {
    ...
    it("valid[4]: ReactDOM.createPortal(child, container);", ({ task }) => {
    ...
    it("valid[5]: ReactDOMServer.renderToString(element);", ({ task }) => {
    ...
    it("valid[6]: ReactDOMServer.renderToStaticMarkup(element);", ({ task }) => {
    ...
    it("valid[7]: var Foo = createReactClass({ render: function() {} })", ({ task }) => {
      const code = `
        var Foo = createReactClass({
          render: function() {}
        })
    ...
    it("valid[8]: var Foo = createReactClassNonReact({ componentWillMount: ...", ({ task }) => {
      const code = `
        var Foo = createReactClassNonReact({
          componentWillMount: function() {},
          componentWillReceiveProps: function() {},
    ...
    it("valid[9]: var Foo = { componentWillMount: function() {}, componentW...", ({ task }) => {
      const code = `
        var Foo = {
          componentWillMount: function() {},
          componentWillReceiveProps: function() {},
    ...
    it("valid[10]: class Foo { constructor() {} componentWillMount() {} comp...", ({ task }) => {
      const code = `
        class Foo {
          constructor() {}
          componentWillMount() {}
    ...
    it("valid[15]: import React from \"react\"; let { default: defaultReactExp...", ({ task }) => {
      const code = `
        import React from "react";
    ...
    it("valid[17]: import ReactDOM, { createRoot } from 'react-dom/client'; ...", ({ task }) => {
      const code = `
        import ReactDOM, { createRoot } from 'react-dom/client';
        ReactDOM.createRoot(container);
        const root = createRoot(container);
    ...
    it("valid[18]: import ReactDOM, { hydrateRoot } from 'react-dom/client';...", ({ task }) => {
      const code = `
        import ReactDOM, { hydrateRoot } from 'react-dom/client';
        ReactDOM.hydrateRoot(container, <App/>);
        hydrateRoot(container, <App/>);
    ...
    it("valid[19]: import ReactDOMServer, { renderToPipeableStream } from 'r...", ({ task }) => {
      const code = `
        import ReactDOMServer, { renderToPipeableStream } from 'react-dom/server';
        ReactDOMServer.renderToPipeableStream(<App />, {});
        renderToPipeableStream(<App />, {});
    ...
    it("valid[20]: import { renderToString } from 'react-dom/server';", ({ task }) => {
      const code = `
        import { renderToString } from 'react-dom/server';
      `;
      task.meta.source = code;
    ...
    it("valid[21]: const { renderToString } = require('react-dom/server');", ({ task }) => {
      const code = `
        const { renderToString } = require('react-dom/server');
      `;
      task.meta.source = code;
  ...
  describe("invalid", () => {
    it("invalid[0]: React.renderComponent()", ({ task }) => {
    ...
    it("invalid[2]: /** @jsx Foo */ Foo.renderComponent()", ({ task }) => {
    ...
    it("invalid[3]: this.transferPropsTo()", ({ task }) => {
    ...
    it("invalid[4]: React.addons.TestUtils", ({ task }) => {
    ...
    it("invalid[5]: React.addons.classSet()", ({ task }) => {
    ...
    it("invalid[6]: React.render(element, container);", ({ task }) => {
    ...
    it("invalid[7]: React.unmountComponentAtNode(container);", ({ task }) => {
    ...
    it("invalid[8]: React.findDOMNode(instance);", ({ task }) => {
    ...
    it("invalid[9]: React.renderToString(element);", ({ task }) => {
    ...
    it("invalid[10]: React.renderToStaticMarkup(element);", ({ task }) => {
    ...
    it("invalid[11]: React.createClass({});", ({ task }) => {
    ...
    it("invalid[13]: React.PropTypes", ({ task }) => {
    ...
    it("invalid[14]: var {createClass} = require('react');", ({ task }) => {
    ...
    it("invalid[15]: var {createClass, PropTypes} = require('react');", ({ task }) => {
    ...
    it("invalid[16]: import {createClass} from 'react';", ({ task }) => {
    ...
    it("invalid[17]: import {createClass, PropTypes} from 'react';", ({ task }) => {
    ...
    it("invalid[18]: import React from 'react'; const {createClass, PropTypes}...", ({ task }) => {
      const code = `
      import React from 'react';
      const {createClass, PropTypes} = React;
    `;
    ...
    it("invalid[19]: import {printDOM} from 'react-addons-perf';", ({ task }) => {
    ...
    it("invalid[20]: import ReactPerf from 'react-addons-perf'; const {printDO...", ({ task }) => {
      const code = `
        import ReactPerf from 'react-addons-perf';
        const {printDOM} = ReactPerf;
      `;
    ...
    it("invalid[21]: React.DOM.div", ({ task }) => {
    ...
    it("invalid[22]: class Bar extends React.PureComponent { componentWillMoun...", ({ task }) => {
      const code = `
        class Bar extends React.PureComponent {
          componentWillMount() {}
          componentWillReceiveProps() {}
    ...
    it("invalid[23]: function Foo() { return class Bar extends React.PureCompo...", ({ task }) => {
      const code = `
        function Foo() {
          return class Bar extends React.PureComponent {
            componentWillMount() {}
    ...
    it("invalid[24]: class Bar extends PureComponent { componentWillMount() {}...", ({ task }) => {
      const code = `
        class Bar extends PureComponent {
          componentWillMount() {}
          componentWillReceiveProps() {}
    ...
    it("invalid[25]: class Foo extends React.Component { componentWillMount() ...", ({ task }) => {
      const code = `
        class Foo extends React.Component {
          componentWillMount() {}
          componentWillReceiveProps() {}
    ...
    it("invalid[26]: class Foo extends Component { componentWillMount() {} com...", ({ task }) => {
      const code = `
        class Foo extends Component {
          componentWillMount() {}
          componentWillReceiveProps() {}
    ...
    it("invalid[27]: var Foo = createReactClass({ componentWillMount: function...", ({ task }) => {
      const code = `
        var Foo = createReactClass({
          componentWillMount: function() {},
          componentWillReceiveProps: function() {},
    ...
    it("invalid[28]: class Foo extends React.Component { constructor() {} comp...", ({ task }) => {
      const code = `
        class Foo extends React.Component {
          constructor() {}
          componentWillMount() {}
    ...
    it("invalid[29]: import { render } from 'react-dom'; ReactDOM.render(<div>...", ({ task }) => {
      const code = `
        import { render } from 'react-dom';
        ReactDOM.render(<div></div>, container);
      `;
    ...
    it("invalid[30]: import { hydrate } from 'react-dom'; ReactDOM.hydrate(<di...", ({ task }) => {
      const code = `
        import { hydrate } from 'react-dom';
        ReactDOM.hydrate(<div></div>, container);
      `;
    ...
    it("invalid[31]: import { unmountComponentAtNode } from 'react-dom'; React...", ({ task }) => {
      const code = `
        import { unmountComponentAtNode } from 'react-dom';
        ReactDOM.unmountComponentAtNode(container);
      `;
    ...
    it("invalid[32]: import { renderToNodeStream } from 'react-dom/server'; Re...", ({ task }) => {
      const code = `
        import { renderToNodeStream } from 'react-dom/server';
        ReactDOMServer.renderToNodeStream(element);
      `;
