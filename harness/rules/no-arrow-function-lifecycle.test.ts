...
describe("no-arrow-function-lifecycle", () => {
  describe("valid", () => {
    it("valid[0]: var Hello = createReactClass({ render: function() { retur...", async ({ task }) => {
      ...
      const matches = ruleErrors(diags, "no-arrow-function-lifecycle", RULE_MESSAGES);
      expect(matches).toHaveLength(0);
    });

    it("valid[1]: var Hello = createReactClass({ getDefaultProps: function(...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[2]: var Hello = createReactClass({ getInitialState: function(...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[3]: var Hello = createReactClass({ getChildContext: function(...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[4]: var Hello = createReactClass({ getDerivedStateFromProps: ...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[5]: var Hello = createReactClass({ componentWillMount: functi...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[6]: var Hello = createReactClass({ UNSAFE_componentWillMount:...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[7]: var Hello = createReactClass({ componentDidMount: functio...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[8]: var Hello = createReactClass({ componentWillReceiveProps:...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[9]: var Hello = createReactClass({ UNSAFE_componentWillReceiv...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[10]: var Hello = createReactClass({ shouldComponentUpdate: fun...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[11]: var Hello = createReactClass({ componentWillUpdate: funct...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[12]: var Hello = createReactClass({ UNSAFE_componentWillUpdate...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[13]: var Hello = createReactClass({ getSnapshotBeforeUpdate: f...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[14]: var Hello = createReactClass({ componentDidUpdate: functi...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[15]: var Hello = createReactClass({ componentDidCatch: functio...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[16]: var Hello = createReactClass({ componentWillUnmount: func...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
    ...
    it("valid[17]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
    ...
    it("valid[18]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[19]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[20]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[21]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[22]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillMount() {}
    ...
    it("valid[23]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[24]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentDidMount() {}
    ...
    it("valid[25]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[26]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[27]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[28]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillUpdate() {}
    ...
    it("valid[29]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[30]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[31]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentDidUpdate() {}
    ...
    it("valid[32]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentDidCatch() {}
    ...
    it("valid[33]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[34]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("valid[35]: var Hello = createReactClass({ getDerivedStateFromProps: ...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          getDerivedStateFromProps: () => { return {}; },
          render: function() { return <div />; }
    ...
    it("valid[36]: class MyComponent extends React.Component { onChange: () ...", async ({ task }) => {
      const code = `
  ...
  describe("invalid", () => {
    it("invalid[0]: var Hello = createReactClass({ render: () => { return <di...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          render: () => { return <div />; }
        });
    ...
    it("invalid[1]: var Hello = createReactClass({ getDefaultProps: () => { r...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          getDefaultProps: () => { return {}; },
          render: function() { return <div />; }
    ...
    it("invalid[2]: var Hello = createReactClass({ getInitialState: () => { r...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          getInitialState: () => { return {}; },
          render: function() { return <div />; }
    ...
    it("invalid[3]: var Hello = createReactClass({ getChildContext: () => { r...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          getChildContext: () => { return {}; },
          render: function() { return <div />; }
    ...
    it("invalid[4]: var Hello = createReactClass({ componentWillMount: () => ...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentWillMount: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[5]: var Hello = createReactClass({ UNSAFE_componentWillMount:...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          UNSAFE_componentWillMount: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[6]: var Hello = createReactClass({ componentDidMount: () => {...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentDidMount: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[7]: var Hello = createReactClass({ componentWillReceiveProps:...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentWillReceiveProps: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[8]: var Hello = createReactClass({ UNSAFE_componentWillReceiv...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          UNSAFE_componentWillReceiveProps: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[9]: var Hello = createReactClass({ shouldComponentUpdate: () ...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          shouldComponentUpdate: () => { return true; },
          render: function() { return <div />; }
    ...
    it("invalid[10]: var Hello = createReactClass({ componentWillUpdate: () =>...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentWillUpdate: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[11]: var Hello = createReactClass({ UNSAFE_componentWillUpdate...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          UNSAFE_componentWillUpdate: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[12]: var Hello = createReactClass({ getSnapshotBeforeUpdate: (...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          getSnapshotBeforeUpdate: () => { return {}; },
          render: function() { return <div />; }
    ...
    it("invalid[13]: var Hello = createReactClass({ componentDidUpdate: () => ...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentDidUpdate: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[14]: var Hello = createReactClass({ componentDidCatch: () => {...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentDidCatch: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[15]: var Hello = createReactClass({ componentWillUnmount: () =...", async ({ task }) => {
      const code = `
        var Hello = createReactClass({
          componentWillUnmount: () => {},
          render: function() { return <div />; }
    ...
    it("invalid[16]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          render = () => { return <div />; }
    ...
    it("invalid[17]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          getDefaultProps = () => { return {}; }
    ...
    it("invalid[18]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          getInitialState = () => { return {}; }
    ...
    it("invalid[19]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          getChildContext = () => { return {}; }
    ...
    it("invalid[20]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("invalid[21]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillMount = () => {}
    ...
    it("invalid[22]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          UNSAFE_componentWillMount = () => {}
    ...
    it("invalid[23]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentDidMount = () => {}
    ...
    it("invalid[24]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillReceiveProps = () => {}
    ...
    it("invalid[25]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          UNSAFE_componentWillReceiveProps = () => {}
    ...
    it("invalid[26]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          shouldComponentUpdate = () => { return true; }
    ...
    it("invalid[27]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillUpdate = () => {}
    ...
    it("invalid[28]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          UNSAFE_componentWillUpdate = () => {}
    ...
    it("invalid[29]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          getSnapshotBeforeUpdate = () => { return {}; }
    ...
    it("invalid[30]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
    ...
    it("invalid[31]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentDidCatch = () => {}
    ...
    it("invalid[32]: class Hello extends React.Component { handleEventMethods ...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          handleEventMethods = () => {}
          componentWillUnmount = () => {}
    ...
    it("invalid[33]: class Hello extends React.Component { render = () => <div...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          render = () => <div />
        }
    ...
    it("invalid[34]: class Hello extends React.Component { render = () => /*fi...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
    ...
    it("invalid[35]: export default class Root extends Component { getInitialS...", async ({ task }) => {
      const code = `
