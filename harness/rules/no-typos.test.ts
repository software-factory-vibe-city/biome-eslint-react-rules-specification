...
describe("no-typos", () => {
  describe("valid", () => {
    it("valid[0]: import createReactClass from 'create-react-class' functio...", async ({ task }) => {
      const code = `
      ...
      const matches = ruleErrors(diags, "no-typos", RULE_MESSAGES);
      expect(matches).toHaveLength(0);
    });

    it("valid[1]: class First { static PropTypes = {key: \"myValue\"}; static...", async ({ task }) => {
      const code = `
        class First {
    ...
    it("valid[2]: class First {} First.PropTypes = {key: \"myValue\"}; First....", async ({ task }) => {
      const code = `
        class First {}
    ...
    it("valid[3]: class First extends React.Component { static propTypes = ...", async ({ task }) => {
      const code = `
    ...
    it("valid[4]: class First extends React.Component {} First.propTypes = ...", async ({ task }) => {
      const code = `
        class First extends React.Component {}
        First.propTypes = {key: "myValue"};
        First.contextTypes = {key: "myValue"};
    ...
    it("valid[5]: class MyClass { propTypes = {key: \"myValue\"}; contextType...", async ({ task }) => {
      const code = `
        class MyClass {
    ...
    it("valid[6]: class MyClass { PropTypes = {key: \"myValue\"}; ContextType...", async ({ task }) => {
      const code = `
        class MyClass {
          PropTypes = {key: "myValue"};
          ContextTypes = {key: "myValue"};
    ...
    it("valid[7]: class MyClass { proptypes = {key: \"myValue\"}; contexttype...", async ({ task }) => {
      const code = `
        class MyClass {
          proptypes = {key: "myValue"};
          contexttypes = {key: "myValue"};
    ...
    it("valid[8]: class MyClass { static PropTypes() {}; static ContextType...", async ({ task }) => {
      const code = `
        class MyClass {
          static PropTypes() {};
          static ContextTypes() {};
    ...
    it("valid[9]: class MyClass { static proptypes() {}; static contexttype...", async ({ task }) => {
      const code = `
        class MyClass {
          static proptypes() {};
          static contexttypes() {};
    ...
    it("valid[10]: class MyClass {} MyClass.prototype.PropTypes = function()...", async ({ task }) => {
      const code = `
        class MyClass {}
    ...
    it("valid[11]: class MyClass {} MyClass.PropTypes = function() {}; MyCla...", async ({ task }) => {
      const code = `
        class MyClass {}
    ...
    it("valid[12]: function MyRandomFunction() {} MyRandomFunction.PropTypes...", async ({ task }) => {
      const code = `
    ...
    it("valid[13]: class First extends React.Component {} First[\"prop\" + \"Ty...", async ({ task }) => {
      const code = `
        class First extends React.Component {}
        First["prop" + "Types"] = {};
        First["context" + "Types"] = {};
    ...
    it("valid[14]: class First extends React.Component {} First[\"PROP\" + \"TY...", async ({ task }) => {
      const code = `
        class First extends React.Component {}
        First["PROP" + "TYPES"] = {};
        First["CONTEXT" + "TYPES"] = {};
    ...
    it("valid[15]: const propTypes = \"PROPTYPES\" const contextTypes = \"CONTE...", async ({ task }) => {
      const code = `
    ...
    it("valid[16]: class Hello extends React.Component { static getDerivedSt...", async ({ task }) => {
      const code = `
    ...
    it("valid[17]: class Hello extends React.Component { \"componentDidMount\"...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          "componentDidMount"() { }
          "my-method"() { }
    ...
    it("valid[18]: class MyClass { componentWillMount() { } componentDidMoun...", async ({ task }) => {
      const code = `
        class MyClass {
          componentWillMount() { }
          componentDidMount() { }
    ...
    it("valid[19]: class MyClass { componentwillmount() { } componentdidmoun...", async ({ task }) => {
      const code = `
        class MyClass {
          componentwillmount() { }
          componentdidmount() { }
    ...
    it("valid[20]: class MyClass { Componentwillmount() { } Componentdidmoun...", async ({ task }) => {
      const code = `
        class MyClass {
          Componentwillmount() { }
          Componentdidmount() { }
    ...
    it("valid[21]: function test(b) { return a.bind(b); } function a() {}", async ({ task }) => {
      const code = `
        function test(b) {
          return a.bind(b);
        }
    ...
    it("valid[22]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
    ...
    it("valid[23]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("valid[24]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("valid[25]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("valid[26]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("valid[27]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
    ...
    it("valid[28]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
    ...
    it("valid[29]: import PropTypes from 'prop-types' import * as MyPropType...", async ({ task }) => {
      const code = `
        import PropTypes from 'prop-types'
    ...
    it("valid[30]: import PropTypes from \"prop-types\" import * as MyPropType...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types"
        import * as MyPropTypes from 'lib/my-prop-types'
        class Component extends React.Component {};
    ...
    it("valid[31]: import CustomReact from \"react\" class Component extends R...", async ({ task }) => {
      const code = `
    ...
    it("valid[32]: class Component extends React.Component {}; Component.pro...", async ({ task }) => {
      const code = `
        class Component extends React.Component {};
        Component.propTypes = {
          a: PropTypes.shape(),
    ...
    it("valid[33]: const fn = (err, res) => { const { body: data = {} } = { ...", async ({ task }) => {
      const code = `
        const fn = (err, res) => {
          const { body: data = {} } = { ...res };
          data.time = data.time || {};
    ...
    it("valid[34]: class Component extends React.Component {}; Component.pro...", async ({ task }) => {
      const code = `
        class Component extends React.Component {};
        Component.propTypes = {
          b: string.isRequired,
    ...
    it("valid[35]: import React from 'react'; import PropTypes from 'prop-ty...", async ({ task }) => {
      const code = `
    ...
    it("valid[36]: import React from 'react'; import PropTypes from 'prop-ty...", async ({ task }) => {
      const code = `
        import React from 'react';
        import PropTypes from 'prop-types';
        const Component = React.createReactClass({
    ...
    it("valid[37]: import React from 'react'; const Component = React.create...", async ({ task }) => {
      const code = `
        import React from 'react';
        const Component = React.createReactClass({
          propTypes: {},
    ...
    it("valid[38]: import { string, element } from \"prop-types\"; class Sampl...", async ({ task }) => {
      const code = `
    ...
    it("valid[39]: import React from 'react'; const A = { B: 'C' }; export d...", async ({ task }) => {
      const code = `
        import React from 'react';
    ...
    it("valid[40]: const MyComponent = React.forwardRef((props, ref) => <div...", async ({ task }) => {
      const code = `
    ...
    it("valid[41]: import styled from \"styled-components\"; const MyComponent...", async ({ task }) => {
      const code = `
    ...
    it("valid[42]: class Editor extends React.Component { #somethingPrivate(...", async ({ task }) => {
      const code = `
  ...
  describe("invalid", () => {
    it("invalid[0]: class Component extends React.Component { static PropType...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static PropTypes = {};
        }
    ...
    it("invalid[1]: class Component extends React.Component {} Component.Prop...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.PropTypes = {}
      `;
    ...
    it("invalid[2]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
    ...
    it("invalid[3]: class Component extends React.Component { static proptype...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static proptypes = {};
        }
    ...
    it("invalid[4]: class Component extends React.Component {} Component.prop...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.proptypes = {}
      `;
    ...
    it("invalid[5]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
        MyComponent.proptypes = {}
      `;
    ...
    it("invalid[6]: class Component extends React.Component { static ContextT...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static ContextTypes = {};
        }
    ...
    it("invalid[7]: class Component extends React.Component {} Component.Cont...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.ContextTypes = {}
      `;
    ...
    it("invalid[8]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
    ...
    it("invalid[9]: class Component extends React.Component { static contextt...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static contexttypes = {};
        }
    ...
    it("invalid[10]: class Component extends React.Component {} Component.cont...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.contexttypes = {}
      `;
    ...
    it("invalid[11]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
        MyComponent.contexttypes = {}
      `;
    ...
    it("invalid[12]: class Component extends React.Component { static ChildCon...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static ChildContextTypes = {};
        }
    ...
    it("invalid[13]: class Component extends React.Component {} Component.Chil...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.ChildContextTypes = {}
      `;
    ...
    it("invalid[14]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
    ...
    it("invalid[15]: class Component extends React.Component { static childcon...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static childcontexttypes = {};
        }
    ...
    it("invalid[16]: class Component extends React.Component {} Component.chil...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.childcontexttypes = {}
      `;
    ...
    it("invalid[17]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
        MyComponent.childcontexttypes = {}
      `;
    ...
    it("invalid[18]: class Component extends React.Component { static DefaultP...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static DefaultProps = {};
        }
    ...
    it("invalid[19]: class Component extends React.Component {} Component.Defa...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
    ...
    it("invalid[20]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
    ...
    it("invalid[21]: class Component extends React.Component { static defaultp...", async ({ task }) => {
      const code = `
        class Component extends React.Component {
          static defaultprops = {};
        }
    ...
    it("invalid[22]: class Component extends React.Component {} Component.defa...", async ({ task }) => {
      const code = `
        class Component extends React.Component {}
        Component.defaultprops = {}
      `;
    ...
    it("invalid[23]: function MyComponent() { return (<div>{this.props.myProp}...", async ({ task }) => {
      const code = `
        function MyComponent() { return (<div>{this.props.myProp}</div>) }
        MyComponent.defaultprops = {}
      `;
    ...
    it("invalid[24]: Component.defaultprops = {} class Component extends React...", async ({ task }) => {
      const code = `
        Component.defaultprops = {}
        class Component extends React.Component {}
      `;
    ...
    it("invalid[25]: /** @extends React.Component */ class MyComponent extends...", async ({ task }) => {
      const code = `
    ...
    it("invalid[26]: class Hello extends React.Component { static GetDerivedSt...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          static GetDerivedStateFromProps()  { }
          ComponentWillMount() { }
    ...
    it("invalid[27]: class Hello extends React.Component { static Getderivedst...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          static Getderivedstatefromprops() { }
          Componentwillmount() { }
    ...
    it("invalid[28]: class Hello extends React.Component { static getderivedst...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          static getderivedstatefromprops() { }
          componentwillmount() { }
    ...
    it("invalid[29]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[30]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[31]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {
          static propTypes = {
    ...
    it("invalid[32]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {
          static propTypes = {
    ...
    it("invalid[33]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[34]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[35]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[36]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[37]: import PropTypes from \"prop-types\"; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from "prop-types";
        class Component extends React.Component {};
        Component.childContextTypes = {
    ...
    it("invalid[38]: import PropTypes from 'prop-types'; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from 'prop-types';
        class Component extends React.Component {};
        Component.childContextTypes = {
    ...
    it("invalid[39]: import PropTypes from 'prop-types'; class Component exten...", async ({ task }) => {
      const code = `
        import PropTypes from 'prop-types';
        class Component extends React.Component {};
        Component.propTypes = {
    ...
    it("invalid[40]: import RealPropTypes from 'prop-types'; class Component e...", async ({ task }) => {
      const code = `
    ...
    it("invalid[41]: import React from 'react'; class Component extends React....", async ({ task }) => {
      const code = `
      import React from 'react';
      class Component extends React.Component {};
      Component.propTypes = {
    ...
    it("invalid[42]: import React from 'react'; class Component extends React....", async ({ task }) => {
      const code = `
        import React from 'react';
        class Component extends React.Component {};
        Component.childContextTypes = {
    ...
    it("invalid[43]: import { PropTypes } from 'react'; class Component extend...", async ({ task }) => {
      const code = `
    ...
    it("invalid[44]: import 'react'; class Component extends React.Component {};", async ({ task }) => {
      const code = `
      import 'react';
      class Component extends React.Component {};
    `;
    ...
    it("invalid[45]: import { PropTypes } from 'react'; class Component extend...", async ({ task }) => {
      const code = `
        import { PropTypes } from 'react';
        class Component extends React.Component {};
        Component.childContextTypes = {
    ...
    it("invalid[46]: import PropTypes from 'prop-types'; class Component exten...", async ({ task }) => {
      const code = `
      import PropTypes from 'prop-types';
      class Component extends React.Component {};
      Component.propTypes = {
    ...
    it("invalid[47]: import PropTypes from 'prop-types'; class Component exten...", async ({ task }) => {
      const code = `
      import PropTypes from 'prop-types';
      class Component extends React.Component {};
      Component.propTypes = {
    ...
    it("invalid[48]: import React from 'react'; import PropTypes from 'prop-ty...", async ({ task }) => {
      const code = `
        import React from 'react';
        import PropTypes from 'prop-types';
        const Component = React.createReactClass({
    ...
    it("invalid[49]: import React from 'react'; import PropTypes from 'prop-ty...", async ({ task }) => {
      const code = `
        import React from 'react';
        import PropTypes from 'prop-types';
        const Component = React.createReactClass({
    ...
    it("invalid[50]: import React from 'react'; const Component = React.create...", async ({ task }) => {
      const code = `
        import React from 'react';
        const Component = React.createReactClass({
          proptypes: {},
    ...
    it("invalid[51]: class Hello extends React.Component { getDerivedStateFrom...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
    ...
    it("invalid[52]: class Hello extends React.Component { GetDerivedStateFrom...", async ({ task }) => {
      const code = `
        class Hello extends React.Component {
          GetDerivedStateFromProps() { }
        }
    ...
    it("invalid[53]: import 'prop-types'", async ({ task }) => {
      const code = `
        import 'prop-types'
      `;
      task.meta.source = code;
