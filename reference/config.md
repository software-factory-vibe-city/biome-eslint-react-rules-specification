...
**Note**: You do _not_ need to list patterns which are [defined](./patterns.md) in Markdown or `.grit` files, they are automatically merged in.
...
If patterns are yielding _false positives_, you should consider modifying the pattern to add [conditions](https://docs.grit.io/language/conditions) that better capture the intent of the code.
